class Manage::Cinema::EventsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event.save
        format.html { redirect_to manage_cinema_cinema_events(@cinema), notice: 'Event was successfully created.' }
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:body, :eventable_type, :eventable_id, :member_id, :start, :deadline)
    end
end
