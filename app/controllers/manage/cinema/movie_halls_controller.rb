class Manage::Cinema::MovieHallsController < Manage::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @movie_hall.save
        format.html { redirect_to manage_cinema_cinema_movie_halls_path(@cinema), notice: 'Picture was successfully created.' }
